	...
	tests := []struct {
		...
		{"root", args{
			json: `[{"a": [{"b": 1, "c": 3}, {"b": 2, "c": 1}], "c": "dd"},
                    ...
                    {"a": [{"b": 3, "c": 2}, {"b": 3, "c": 3}]}]`,
			stmt: `find $val where [$val /] {[/a/b eq(2)][/a/c eq(2)]}`},
			[]byte(`[{"val":{"a":[{"b":1,"c":3},{"b":2,"c":1}],"c":"dd"}},{"val":{"a":[{"b":2,"c":2},{"b":3,"c":2}],"d":"a"}},{"val":{"a":[{"b":3,"c":2},{"b":3,"c":3}]}}]`),
		},
		{"sub path", args{
			json: `[{"a": [{"b": 1, "c": 2}, {"b": 2, "c": 1}], "c": "dd"},
			                    {"a": [{"b": 2, "c": 2}, {"b": 3, "c": 2}], "d": "a"},
			                    {"a": [{"b": 3, "c": 2}, {"b": 3, "c": 3}]}]`,
			stmt: `find $val where [$val /a] {[/a/b eq(2)][/a/c eq(2)]}`},
			[]byte(`[{"val":[{"b":1,"c":2},{"b":2,"c":1}]},{"val":[{"b":2,"c":2},{"b":3,"c":2}]},{"val":[{"b":3,"c":2},{"b":3,"c":3}]}]`),
		},
	}
