	...
	tests := []struct {
		...
		{"text", args{
			json: `[{"a": [{"b": 1, "c": 3}, {"b": 2, "c": 1}], "c": "dd"},
                    ...
                    {"a": [{"b": 3, "c": 2}, {"b": 3, "c": 3}]}]`,
			stmt: `find $val where [$val /] [/d in("aa", "a")]`},
			[]byte(`[{"val":{"a":[{"b":2,"c":2},{"b":3,"c":2}],"d":"a"}}]`),
		},
		{"float", args{
			json: `[{"a": [{"b": 1, "c": 3}, {"b": 2, "c": 1}], "c": "dd", "k": 1.5},
                    {"a": [{"b": 2, "c": 2}, {"b": 3, "c": 2}], "d": "a", "k": 2.5},
                    {"a": [{"b": 3, "c": 2}, {"b": 3, "c": 3}], "k": 0.5}]`,
			stmt: `find $val where [$val /] [/k in(0.5, 3.5)]`},
			[]byte(`[{"val":{"a":[{"b":3,"c":2},{"b":3,"c":3}],"k":0.5}}]`),
		},
		{"int", args{
			json: `[{"a": [{"b": 1, "c": 3}, {"b": 2, "c": 1}], "c": "dd", "k": 15},
                    {"a": [{"b": 2, "c": 2}, {"b": 3, "c": 2}], "d": "a", "k": 25},
                    {"a": [{"b": 3, "c": 2}, {"b": 3, "c": 3}], "k": 5}]`,
			stmt: `find $val where [$val /] [/k in(25, 15)]`},
			[]byte(`[{"val":{"a":[{"b":1,"c":3},{"b":2,"c":1}],"c":"dd","k":15}},{"val":{"a":[{"b":2,"c":2},{"b":3,"c":2}],"d":"a","k":25}}]`),
		},
	}
